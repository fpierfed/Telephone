...
struct ExpectedProducts {
    private let map = [
        "org.fpierfed.Telephone.iap.month": NSLocalizedString("Monthly", comment: "Product name."),
        "org.fpierfed.Telephone.iap.year": NSLocalizedString("Yearly", comment: "Product name.")
    ]
