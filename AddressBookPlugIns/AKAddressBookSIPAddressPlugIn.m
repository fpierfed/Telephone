...
- (NSString *)titleForPerson:(ABPerson *)person identifier:(NSString *)identifier {
    NSBundle *bundle = [NSBundle bundleWithIdentifier:@"org.fpierfed.TelephoneAddressBookSIPAddressPlugIn"];
...
- (void)performActionForPerson:(ABPerson *)person identifier:(NSString *)identifier {
    ...
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"bundleIdentifier == 'org.fpierfed.Telephone'"];
...
- (void)workspaceDidLaunchApplication:(NSNotification *)notification {
    ...
    if ([bundleIdentifier isEqualToString:@"org.fpierfed.Telephone"] && [self shouldDial]) {
        [self setShouldDial:NO];
